...
const categories = [
  { name: "Mobiles", icon: "📱", color: "from-blue-500 to-cyan-500" },
  { name: "Electronics", icon: "💻", color: "from-purple-500 to-pink-500" },
  { name: "Fashion", icon: "👗", color: "from-rose-500 to-orange-500" },
  { name: "Home", icon: "🏠", color: "from-emerald-500 to-teal-500" },
  { name: "Beauty", icon: "💄", color: "from-pink-500 to-red-500" },
  { name: "Sports", icon: "⚽", color: "from-green-500 to-lime-500" },
  { name: "Books", icon: "📚", color: "from-amber-500 to-yellow-500" },
  { name: "Toys", icon: "🎮", color: "from-indigo-500 to-blue-500" },
]
